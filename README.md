...
- Agent — PydanticAI with `gpt-4.1-mini` and 9 documented tools. Falls back to a deterministic path when no API key is set. See [`ai/week1-rag/pydantic_agent.py`](ai/week1-rag/pydantic_agent.py) and [`docs/agent-tools.md`](docs/agent-tools.md).
